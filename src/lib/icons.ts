...
import { faLock, faLockOpen, faCircle, faDotCircle, faCircleNotch } from '@fortawesome/free-solid-svg-icons'
...
export default () => {
  library.add(faLock, faLockOpen, faCircle, faDotCircle, farDotCircle, faCircleNotch)
}
